...
| [*Code: Terraform*](https://store.steampowered.com/app/868160/Code_Terraform) | A terraforming game set on a frozen alien planet where every machine, vehicle, drone, and atmospheric system is controlled by Python-style scripts. Industrial automation chains (mining → smelter → fabricator → shipping), atmospheric simulation, and a story-driven mystery uncovered through transmissions. Custom tree-walking interpreter. Free Steam demo available. |
...
| [*Minecraft Hour of Code*](https://code.org/minecraft) | Learn CS and AI fundamentals (legally and with due process) in Minecraft. |
...
| [*Replicube*](https://store.steampowered.com/app/3401490/Replicube/) | Puzzle game about writing code in Lua to replicate 3-D voxel objects. |
...
| [*Flexbox Zombies*](https://mastery.games/post/flexboxzombies2/) | Mow down an onslaught of horrendous zombies with nothing more than a crossbow and, of course, Flexbox. |
...
| [*Programming Game*](https://programming-game.com/) | Real-time survival MMORPG where player characters are of course programmed. Includes a demo demonstrating how to play. The game is geared towards TypeScript and can be played entirely in the browser or through a locally developed client that imports and uses the NPM module [programming-game](https://www.npmjs.com/package/programming-game); however, the server API itself is language-agnostic and players report using other languages such as Python for client code. [Documentation](https://programming-game.com/docs/getting-started) is currently a bit sparse but a [Discord server](https://discord.com/invite/xdzwSV4aqZ) exists to help aspring players. |
